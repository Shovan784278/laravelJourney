<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets/images/custom-logo.png')}}" alt="logo-light" height="35">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            {{-- This is header language feature --}}
